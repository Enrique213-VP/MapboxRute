...
class MainActivity : BaseActivity(), OnMapClickListener, OnMapLongClickListener {
        ...
        binding.apply {
            ...
            navView.setNavigationItemSelectedListener {
                when (it.itemId) {
                    ...
                    R.id.favPlaces -> {
                        Toast.makeText(this@MainActivity, "Tus favoritos!", Toast.LENGTH_LONG)
                            .show()
                        val intent =
                            Intent(this@MainActivity, FavoritePlacesActivity::class.java).also {
    ...
    override fun onMapLongClick(point: Point): Boolean {
        ...
        dialog.setPositiveButton(getString(R.string.acept)) { dialog, id ->
            ...
            addAnnotationToMap(point.longitude(), point.latitude(), textEdit.toString())
        }
